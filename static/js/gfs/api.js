...
export async function getJson(url, opts = {}) {
  ...
  const run = (async () => {
    ...
    try {
      console.info('[gfs/request] start', { layer: upperMethod === 'GET' ? gfsRequestKey(url) : upperMethod, url, params: parseUrlParams(url), method: upperMethod });
